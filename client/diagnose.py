...
def check_network_connection(server="www.baidu.com"):
    """
    Checks if kair can connect a network server.
...
def run():
    ...
    logger.info("Starting kair diagnostic at %s" % time.strftime("%c"))
    ...
    for fname in [os.path.join(kairpath.APP_PATH, os.pardir,
                               "phonetisaurus",
                               "g014b2b.fst")]:
